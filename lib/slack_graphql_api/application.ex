defmodule SlackGraphqlApi.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(SlackGraphqlApi.Repo, []),
    ...
    opts = [strategy: :one_for_one, name: SlackGraphqlApi.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SlackGraphqlApiWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
